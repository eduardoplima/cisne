"""
Django settings for cisne project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', default='django-insecure-40@c0gt!6r@s-ii*1x&akns5iykkv=tbim^(d&(%@ubd8jl$ug')
ALLOWED_HOSTS = []
...
WSGI_APPLICATION = 'cisne.wsgi.application'
